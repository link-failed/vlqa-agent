...
$commands = @(
    ...
    'python baseline/run.py  --model-id "o3-mini" --use-azure-auth --max-tasks 450 --split default --concurrency 8',
    'python baseline/run3.py --model-id "o3-mini" --use-azure-auth --max-tasks 450 --split default --concurrency 8',
    'python baseline/run2.py --model-id "gpt-4o" --use-azure-auth --max-tasks 450 --split default --concurrency 8',
    'python baseline/run.py  --model-id "gpt-4o" --use-azure-auth --max-tasks 450 --split default --concurrency 8'
)
