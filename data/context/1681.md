Thoughts:
I should firstly load the fees data and merchant data from their respective JSON files. Then, I need to extract the target merchant's information and filter transactions for the 10th day and the target month of the year 2023. 
