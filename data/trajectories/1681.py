...
def get_applicable_fee_ids():
    ...
    # Filter transactions for the target merchant and month
    ...
    # Calculate monthly fraud level and volume based on all transactions for the target month
    ...
    for transaction in relevant_transactions:
        ...
        for fee in fees_data:
            ...
            if (
                (fee_aci_list == [] or transaction_aci in fee_aci_list) and  # Ensure aci comparison is consistent
