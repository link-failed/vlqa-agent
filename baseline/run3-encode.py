...
def get_relevant_table_info(task_id: str) -> str:
    """Get relevant table information for a given task ID"""
...
def load_referred_tasks_mapping():
    ...
    def get_random_referred_id():
        return [str(random.choice(referred_pool))]
...
def run_single_task(
    ...
    relevant_table_info = get_relevant_table_info(task_id)
...
def main():
    ...
    runs_dir = Path().resolve() / "encode_res/runs3"  # Changed directory name
