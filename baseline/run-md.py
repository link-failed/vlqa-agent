...
def load_fee_matching_content():
    """Load the fee matching documentation content"""
    ...
    try:
        with open(fee_matching_path, 'r', encoding='utf-8') as f:
            content = f.read()
        return f"\n\nFee Matching Documentation:\n{content}\n"
    except FileNotFoundError:
        logger.warning(f"Fee matching file not found at {fee_matching_path}")
        return ""
